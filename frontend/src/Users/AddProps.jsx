  ...
  <div> 
    ...
    <Form.Group controlId="bankLoan">
      <div className="input-card">
        ...
        <Dropdown  className="custom-scroll-menu">
      ...
      <div className="input-card">
        ...
        <Dropdown>
          ...
          <Dropdown.Menu  className="custom-scroll-menu">
            ...
            <Dropdown.Item onClick={() => setPropertyDetails({ ...propertyDetails, propertyAge: "Newly Built" })}>
              Newly Built
            </Dropdown.Item>
    ...
    <Form.Group controlId="floorNo">
      <div className="input-card">
        ...
        <Dropdown>
          ...
          >
            {propertyDetails.floorNo || "Select No. of Floors"}
          </Dropdown.Toggle>
          ...
          <Dropdown.Menu className="custom-scroll-menu">
            ...
            <Dropdown.Item onClick={() => setPropertyDetails({ ...propertyDetails, floorNo: "UnderGround" })}>
              UnderGround
            </Dropdown.Item>
            <Dropdown.Item onClick={() => setPropertyDetails({ ...propertyDetails, floorNo: "GroundFloor" })}>
              Ground Floor
            </Dropdown.Item>
            {Array.from({ length: 20 }, (_, index) => {
              const floor = `${index + 1}`;
      ...
      <div className="input-card">
        ...
        <Dropdown>
          ...
          <Dropdown.Menu className="custom-scroll-menu">
            ...
            {Array.from({ length: 10 }, (_, index) => {
              const balcony = `${index + 1} Balcony${index + 1 > 1 ? "s" : ""}`;
              return (
                <Dropdown.Item key={balcony} onClick={() => setPropertyDetails({ ...propertyDetails, balconies: balcony })}>
                  {balcony}
                </Dropdown.Item>
              );
            })}
